...
import styles from "./DiningHero.module.scss";
    ...
    <Box component="section" className={styles.hero}>
      ...
      <Container maxWidth="xl" className={styles.container}>
        <Box className={styles.eyebrow}>
          ...
          <Typography className={styles.eyebrowText}>Ristorazione</Typography>
          <span className={styles.eyebrowLine} />
        </Box>
        ...
        <Typography className={styles.subheading}>
          Sapori genuini di montagna, prodotti locali e stagionali.
          <br />
          Una cucina che cambia col bosco che la circonda.
        </Typography>

        <Box className={styles.pills}>
          <span className={styles.pill}>🍽️ Menu completo sab & dom</span>
          <span className={styles.pill}>📅 Infrasettimanale su prenotazione</span>
          <span className={styles.pill}>🎒 Pranzo al sacco disponibile</span>
        </Box>
      </Container>
    </Box>
  );
